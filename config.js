...
module.exports = {
  ...
  AUDIO_DATA: process.env.AUDIO_DATA || '𝄞⃝🍃𝑅𝛩𝑌𝛥𝐿 𝛯𝐹𝛸 𝄞⃝🍃;https://files.catbox.moe/v84o9c.jpg',
  ...
  CONTEXTINFO: process.env.CONTEXTINFO || `{"title": "𝐑͢ᴏʏ݉ᴀʟ͎ 𝐒͢ᴇ݉ʀ͎", "body": "ᴀᴡᴇꜱᴏᴍᴇ 🍉", "thumbnailUrl": "https://files.catbox.moe/v84o9c.jpg", "renderLargerThumbnail": false, "mediaType": 1, "mediaUrl": "", "sourceUrl": "https://github.com/Loki-Xer/Jarvis", "showAdAttribution": true}`,
  ...
  MEDIA_DATA: process.env.MEDIA_DATA|| 'ROYAL-XMD;𝐑͢ᴏʏ݉ᴀʟ͎ 𝐒͢ᴇ݉ʀ͎;https://graph.org/file/58ea74675af7836579a3a.jpg',
  ...
  TIMEZONE: process.env.TIMEZONE || "India/Kerala",
